...
typedef enum {
    ...
    LED2 =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 2),
	  ...
	  LED7 =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 7),
		SW0  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 8),
    SW1  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 9),
    SW2  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 10),
		SW3  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 11),
		SW4  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 12),
		SW5  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 13),
		SW6  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 14),
	  SW7  =  (uint32_t)(((XPAR_GPIO_0_DEVICE_ID) << 16) | (0x01 << 8) | 15),
